...
3. Build the frontend — see [Frontend Setup](./Installation/frontend-setup).
...
6. Run the offline test suite before going live — see [Testing Checklist](./Guides/testing-checklist).
...
- Review [Production notes in Release Notes](./Development/release-notes) before shipping to a live server.
