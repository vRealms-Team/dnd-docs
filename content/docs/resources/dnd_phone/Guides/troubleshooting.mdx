...
- If it's fully built and still blank, check the F8 console for a JS error — the site's [Architecture Notes](../Development/architecture-notes) covers the NUI communication pattern if you're debugging a custom bridge.
